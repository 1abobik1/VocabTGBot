...
HELP_TEXT = (
    ...
    "«В очередь», «Исправить» или «Удалить». Если новых слов в очереди не осталось, "
    "ИИ сам предложит слово на случайную тему за 20 минут до карточки — пока не наберётся дневная норма "
    "новых слов.\n\n"
