...
- **AI cards**: `/gen 5 travel`, or add a word yourself and the AI writes three examples (past, present, future) at your level using the grammar you have gaps in. The same word is never offered twice. When no new words are left, the AI suggests one on a random topic until the daily quota of new words is reached.
- **Practice at 10:00**: type learned words in both directions; a typo is "almost", a mistake means learning it again.
