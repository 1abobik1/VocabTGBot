...
- **🗣 Your own sentences instead of «Знаю»** — typed or as **voice messages**, one at a time if you like. The AI reviews each one right away, shows how to say it more naturally and gives a common phrase with the word. Up to 4 sentences; correct in two — the word counts.
