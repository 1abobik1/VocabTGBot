...
- **Карточки по расписанию**: 14 слотов в день, из них 6 под новые слова; кнопки «Знаю», «Не знаю», «📥 В архив». Интервалы: сутки → три дня → практика; «Не знаю» откладывает на 30 минут, 2 часа, завтра.
- **🗣 Свои предложения вместо «Знаю»** — текстом или **голосовыми**, по одному и без лимита. ИИ сразу разбирает каждое и показывает, как сказать естественнее, а по «🏁 Готово» — советует, как ещё употребляют слово, с двумя примерами. Верно в двух — слово засчитано.
- **ИИ-карточки**: `/gen 5 путешествия` или добавь слово сам — ИИ допишет два примера на твоём уровне и на грамматике, где у тебя пробелы. Одно слово дважды не предлагается.
