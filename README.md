...
- **10 карточек в день по расписанию** По дефолту (10:00–23:00 МСК). Перевод скрыт под спойлером, под карточкой кнопки «Знаю», «Не знаю» и «📥 В архив» — последняя сразу отправляет слово в архив, минуя остальные шаги.
