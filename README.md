...
- **🗣 Свои предложения вместо «Знаю»** — текстом или **голосовыми**, можно по одному. ИИ сразу разбирает каждое, показывает, как сказать естественнее, и даёт частую фразу со словом. До 4 предложений; верно в двух — слово засчитано.
