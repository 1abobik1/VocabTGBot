...
- **Карточки по расписанию**: 14 слотов в день, из них 6 под новые слова; кнопки «Знаю», «Не знаю», «📥 В архив» (сразу присылает следующее слово). Интервалы: сутки → три дня → практика; «Не знаю» откладывает на 30 минут, 2 часа, завтра. После «Знаю» ИИ присылает совет, как ещё употребляют слово, с примерами в трёх временах.
...
- **ИИ-карточки**: `/gen 5 путешествия` или добавь слово сам — ИИ допишет три примера (прошедшее, настоящее, будущее время) на твоём уровне и на грамматике, где у тебя пробелы. Одно слово дважды не предлагается. Кончились новые слова — ИИ сам предложит слово на случайную тему, пока не наберётся дневная норма.
- **Практика в 10:00**: выученные слова нужно написать в обе стороны; опечатка — «почти», ошибка — учить заново.
